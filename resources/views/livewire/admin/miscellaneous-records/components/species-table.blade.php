    ...
    <div class="flex flex-col ">
        <div class="flex justify-between mt-3">
            ...
            <button type="button"
                ...
                data-te-toggle="modal" data-te-target="#form-create" data-te-ripple-init data-te-ripple-color="light">
                Novo
            </button>
        ...
        <div wire:ignore.defer data-te-modal-init
            ...
            id="form-create" tabindex="-1" aria-labelledby="form-createLabel" aria-modal="true" role="dialog">
