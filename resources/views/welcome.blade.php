        ...
        <div class="p-6 mx-auto max-w-7xl lg:p-8">
            <div class="flex justify-center">
                <a class="relative inline-block overflow-hidden align-bottom rounded-full" data-te-ripple-init
                    ...
                    <img src="{{ asset('assets/images/canva.png') }}" alt="Avatar"
                        class="h-auto max-w-[60px] rounded-full"  style="width: 300px"/>
                </a>
            </div>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                    <a href=""
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Sweet Lounge Pet</h2>

                            <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                              41-3085-2508    41-99274-2861
                            </p>
                        </div>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                    <a href=""
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Em Construção</h2>
